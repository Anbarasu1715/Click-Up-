...
namespace WindowsFormsApp1
{
    ...
    public class UCComboBox : UserControl
    {
        ...
        {
            IconColor=ColorTranslator.FromHtml(ThemeManager.GetDynamicColor(color));
            base.BackColor=ColorTranslator.FromHtml(ThemeManager.GetDynamicColor(color));
        }

        public void SetBaseColor(string color ) 
        {
            lblText.BackColor = ColorTranslator.FromHtml(ThemeManager.GetDynamicColor(color));
            btnIcon.BackColor = ColorTranslator.FromHtml(ThemeManager.GetDynamicColor(color));
        }
